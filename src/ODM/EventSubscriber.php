...
/**
 * Event subscriber for ODM events
 */
class EventSubscriber implements EventSubscriberInterface
{
    ...
    /**
     * @param NodeStrategyProviderInterface $nodeStrategyProvider
     */
    public function __construct(NodeStrategyProviderInterface $nodeStrategyProvider)
    {
    ...
    public function postLoad(LifecycleEventArgs $event)
    {
        ...
        if ($object instanceof Node) {
            $object->setStrategyProvider($this->nodeStrategyProvider);
        }
    }
}
