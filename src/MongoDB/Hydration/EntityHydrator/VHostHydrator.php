...
class VHostHydrator extends ReflectionHydrator
{
    /**
     * {@inheritDoc}
    ...
    public function __construct(DriverInterface $driver)
    {
        ...
        $this->addStrategy('aliases', $driver->getTypeHydrationStrategy(DriverInterface::STRATEGY_DYNAMIC));
        $this->addStrategy('enableSsl', $driver->getTypeHydrationStrategy(DriverInterface::STRATEGY_DYNAMIC));
